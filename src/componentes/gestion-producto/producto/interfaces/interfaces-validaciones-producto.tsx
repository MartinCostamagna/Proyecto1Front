...
export const schema = (utilizaStockMinimo: boolean, utilizaPack: boolean, usaOferta: boolean) =>
  yup.object().shape({
    ...
    precio: yup.number().typeError("El precio debe ser un valor númerico").required("El precio es obligatorio").moreThan(0, "El precio resultante debe ser mayor a 0").test("precio-mayor-o-igual-costo","El precio debe ser mayor o igual que el costo", function(value){
    ...
    motivo: yup.string().optional().nullable(), 
