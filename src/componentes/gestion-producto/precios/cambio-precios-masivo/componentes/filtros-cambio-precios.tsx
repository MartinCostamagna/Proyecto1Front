  ...
  return (
    <CardHeader className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 p-4">
      ...
      <div className="flex flex-col md:flex-row flex-wrap gap-4 w-full">
        ...
        <div className="flex gap-4 items-end flex-grow flex-wrap">
          <Button
            variant="outline"
            onClick={onBuscar}
            className="self-end bg-blue-500 text-white hover:bg-blue-800"
          ...
          <div className="flex flex-col gap-2 min-w-[160px]">
            <label className="text-xs font-medium text-gray-700 dark:text-gray-200">Tipo</label>
          ...
          <div className="flex flex-col gap-2 min-w-[150px]">
            <label className="text-xs font-medium text-gray-700 dark:text-gray-200">
              {tipoActualizacion === "PORCENTAJE" ? "Porcentaje" : "Monto"}
            </label>
            <Input
              type="number"
              step="0.01"
              ...
              placeholder={tipoActualizacion === "PORCENTAJE" ? "10" : "50"}
