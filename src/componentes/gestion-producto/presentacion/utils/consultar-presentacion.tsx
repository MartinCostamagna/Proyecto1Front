...
export default function ConsultarPresentaciones() {
  ...
  // FILTROS LOCALES
  // ===========================
  const [filtrosPresentacion, setFiltrosPresentacion] =
    useState<FiltrosPresentacionValues>({ denominacion: "" });
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      const response: ResponsePost = await PresentacionService.eliminar(
        id,
        usuarioId
      );
